...
function Createlead(props) {
    ...
    const onSubmit = (data) => {
        console.log(data);
        if (data.source != "Enter source") {
            dispatch(createlead(data));
            if (leadcreated) {
                props.history.push('/leads');
            }
        } else {
            sourceref.current.innerHTML = "source required"
        }
    }
    return (
        <React.Fragment>
                    ...
                    <div className="card-body">
                        <form className="form" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="form-group">
                                ...
                                <select className="form-control" name="source" id="source" {...register('source', { required: { value: true, message: "source required" } })}>
